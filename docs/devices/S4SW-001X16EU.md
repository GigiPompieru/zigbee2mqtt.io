...
Starting with firmware 1.7.1 the local web interface allows switching between Matter and Zigbee.
After a reboot, the Zigbee menu is available in the web interface where a `Start Pairing` button is available.
